...
export const ARCHETYPES: Archetype[] = [
  // ===== Clássicos =====
  build({
    id: "leao", name: "Leão", glyph: "◬", group: "classico",
  ...
  build({
    id: "aguia-forca", name: "Águia · Força e Poder", glyph: "▲", group: "classico",
  ...
  build({
    id: "aguia-visao", name: "Águia · Visão de Longo Alcance", glyph: "▲", group: "classico",
  ...
  build({
    id: "aguia-elevacao", name: "Águia · Elevação", glyph: "▲", group: "classico",
  ...
  build({
    id: "coruja", name: "Coruja", glyph: "◉", group: "classico",
    function: "Observação",
